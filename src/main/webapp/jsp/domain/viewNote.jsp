                       ...
                       <!--  <div class="form-group select-width">
                        ...
                        <div align="left" id="t1">
							<div class="form-group">
								...
								<textarea class="form-control" rows="5" id="content">${note.content}</textarea>
                        ...
                        <br/>
                        <div align="center">
                            <button type="button" id='submitBtn' class="btn btn-primary" onclick="addNote()">Update</button>
